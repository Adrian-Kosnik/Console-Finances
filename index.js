...
console.log(
  `    Financial Analysis
    ...
    Greatest Increase in Profits: ${greatestIncreaseProfit[0][0]} ($${
    greatestIncreaseProfit[0][1]
  })
    Greatest Decrease in Profits: ${greatestDecreaseProfit[0][0]} ($${
    greatestDecreaseProfit[0][1]
  })`
);
